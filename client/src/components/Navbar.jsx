...
import { LogOut, Upload, Camera, User, LayoutDashboard, ShieldCheck, UserPlus } from 'lucide-react';
                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <Link to="/" className="flex items-center gap-2.5 group">
                        ...
                        <span className="font-bold text-textMain text-base tracking-tight">
                            AI <span className="text-accent">Media</span>
                        </span>
                    </Link>
                    ...
                    <div className="flex items-center gap-1">
                        {user ? (
                            <>
                                ...
                                <div className="flex items-center gap-2 ml-3 pl-3 border-l border-borderColor">
